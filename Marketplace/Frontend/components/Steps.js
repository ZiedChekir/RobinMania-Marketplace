    ...
    <Container>
      <Grid container alignItems="stretch" rowSpacing={3} columnSpacing={3}>
        <Grid item xs={12} md={6} lg={3} style={{ display: "flex" }}>
          <Card
            sx={{ minWidth: 275, backgroundColor: "#272935" }}
            variant="outlined"
            style={{
              display: "flex",
          ...
          >
            <CardContent>
              ...
              <Typography variant="body2" sx={{ color: "white" }}>
                Once You&apos;ve Set Up Your Wallet, Connect it by Clicking the
        ...
        <Grid item xs={12} md={6} lg={3} style={{ display: "flex" }}>
          ...
          >
            <CardContent>
              ...
              <br />
              <Typography variant="body2" sx={{ color: "white" }}>
                Choose Between Auctions, Price Listings. You Choose How You Want
                To Sell Your NFTs. & We Help You!
              </Typography>
            </CardContent>
            <CardActions>
              <Button size="small" color="secondary">
